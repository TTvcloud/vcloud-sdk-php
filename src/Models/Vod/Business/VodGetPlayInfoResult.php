...
class VodGetPlayInfoResult extends \Google\Protobuf\Internal\Message
{
     ...
     *          播放列表数量
     *     @type \Vcloud\Models\Vod\Business\VodAdaptiveInfo $AdaptiveInfo
     *           dash播放信息
     *     @type \Vcloud\Models\Vod\Business\VodPlayInfo[]|\Google\Protobuf\Internal\RepeatedField $PlayInfoList
     *          播放列表
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.Vcloud.Models.Vod.VodAdaptiveInfo AdaptiveInfo = 8;</code>
     * @return \Vcloud\Models\Vod\Business\VodAdaptiveInfo
     */
     ...
     *
     * Generated from protobuf field <code>.Vcloud.Models.Vod.VodAdaptiveInfo AdaptiveInfo = 8;</code>
     * @param \Vcloud\Models\Vod\Business\VodAdaptiveInfo $var
     * @return $this
     */
    public function setAdaptiveInfo($var)
    {
        GPBUtil::checkMessage($var, \Vcloud\Models\Vod\Business\VodAdaptiveInfo::class);
     ...
     *
     * Generated from protobuf field <code>repeated .Vcloud.Models.Vod.VodPlayInfo PlayInfoList = 9;</code>
     * @param \Vcloud\Models\Vod\Business\VodPlayInfo[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setPlayInfoList($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Vcloud\Models\Vod\Business\VodPlayInfo::class);
