...
class GetRecPostersData extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Vcloud\Models\Vod\StoreUriGroup[]|\Google\Protobuf\Internal\RepeatedField $StoreUriGroups
     *          封面图信息
     ...
     *
     * Generated from protobuf field <code>repeated .Vcloud.Models.Vod.StoreUriGroup StoreUriGroups = 1;</code>
     * @param \Vcloud\Models\Vod\StoreUriGroup[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setStoreUriGroups($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Vcloud\Models\Vod\StoreUriGroup::class);
